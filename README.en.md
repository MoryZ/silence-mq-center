...
silence-mq-center is a Spring Boot-based RocketMQ management console that provides comprehensive monitoring,
diagnostics, and management features for message queues to operations teams and developers.
