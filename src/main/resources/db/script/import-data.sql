...
INSERT IGNORE INTO `rmq_permission_type` (`permission_code`, `permission_name`, `description`, `status`) VALUES
...
(`topic_name`, `cluster_name`, `description`, `owner_id`, `owner_name`, `read_queue_nums`, `write_queue_nums`, `message_type`, `broker_addr`, `is_system_topic`, `status`)
VALUES
('Order-Topic', 'DefaultCluster', '订单Topic', 1, 'admin', 8, 8, 'NORMAL', '127.0.0.1:10911', 0, 'ACTIVE'),
...
(`user_id`, `user_name`, `topic_id`, `topic_name`, `permission_type_id`, `permission_code`, `granted_by_id`, `granted_by_name`, `status`)
VALUES
(2, 'system_a', 1, 'Order-Topic', 3, 'PRODUCE', 1, 'admin', 'ACTIVE'),
...
VALUES
('CONTENT_GROUP', 10, 500, 'system', 'system');
