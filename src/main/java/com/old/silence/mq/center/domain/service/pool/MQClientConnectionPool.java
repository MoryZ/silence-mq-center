...
public class MQClientConnectionPool implements InitializingBean, DisposableBean {
    ...
    public static class PoolStats {
        ...
        public final int transactionProducerQueueSize;
        
        public PoolStats(int activeConnections, int idleConnections, 
                        int maxConnections, int transactionProducerQueueSize) {
            this.activeConnections = activeConnections;
            this.idleConnections = idleConnections;
            this.maxConnections = maxConnections;
            this.transactionProducerQueueSize = transactionProducerQueueSize;
        }
